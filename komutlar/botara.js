...
exports.run = async (client, msg, args) => {
    ...
    if(!args[0]) {
      return msg.channel.send(new Discord.RichEmbed().setDescription('Lütfen bir bot ID\'i giriniz!'))
    }
    request(`https://discord-bots-world.glitch.me/bot/${args[0]}`, function (error, response, body) {
    if (error) return msg.channel.send('Hata:', error);
      ...
      var f = db.fetch(`botlar.${args[0]}.sahip`)
      ...
      request(`https://discord-bots-world.glitch.me/bot`, function (errorr, responsee, bodyy) {
